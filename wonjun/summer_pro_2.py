...
# 데이터 로드
earthquakes_df = pd.read_csv('/Users/marista/Desktop/project/USC-DS-Project-main/data/earthquakes/database.csv')
# CSV 파일 경로
csv_file = '/Users/marista/Desktop/project/USC-DS-Project-main/data/ufo/complete.csv'
# CSV 파일을 읽어올 때 경고 메시지 무시하고 데이터 유형 설정
ufo_df = pd.read_csv(csv_file, on_bad_lines='skip', dtype=str, low_memory=False)
